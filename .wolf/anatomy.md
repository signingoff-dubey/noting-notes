...
- `ai.py` — Pydantic models for AI endpoints. (~213 tok)

## backend/routes/

- `ai.py` — AI routing — Ollama + OpenAI-compatible. (~1753 tok)

## backend/services/

- `ai_service.py` — Ollama + OpenAI-compatible AI client. (~2191 tok)
...
- `App.jsx` — NoteEditor (~1712 tok)
- `index.css` — Styles: 3 rules, 224 vars (~7726 tok)
...
- `Dashboard.jsx` — getGreeting (~3054 tok)
- `Journal.jsx` — MOOD_OPTIONS (~5196 tok)
- `Notes.jsx` — SORT_OPTIONS (~1851 tok)
- `Settings.jsx` — useEditorSettings (~5691 tok)
- `TagsView.jsx` — TagsView (~1691 tok)
